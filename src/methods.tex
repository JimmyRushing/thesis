...
geometies. This is achieve with the predifined interatomic potenials (atomistic forcfield file) were adapted
from the Optimized Potentials for Liquid Simulations United Atom(OPLS-UA).

The ITIC data was generated expressly for use in \autoref{itic}. 
