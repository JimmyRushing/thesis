...
The driving force, $\Delta E_{ij}$, for a one electron charge transfer reaction, 
...
\begin{align}
    ...
    \label{gibbs}
\end{align}
The values $E_{homo, i}$ and $E_{homo, j}$ represent the eigenvalues of the the
...
the dimer splitting methed \cite{Huang2005b}. This method comares the HOMO energies for the  chromophores in isolation,
$\Delta E_{ij}$, to the energies of the frontier molecular orbitals of a dimer
