...
updated based on this solution and they are pushed and pulled in accordance with
...
\label{marcusmodel}
 ...
 free charges movement through a morphology can be modeled as a series of Marcus nonadiabatic electron transfer
...
documented and controlled way to merge together divergent code through pull requests and unit testing. 
...
Using \texttt{Planckton-flow}, a sister package
