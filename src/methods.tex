...
below. First, we introduce MD genrally and describe two disticnt means by which the P3HT and ITIC chemistries
were obtained. 
...
voronoi analysis.
After chopping up the morphology into chromophores, we are required to perform some neighborlisting prior to QCC. so categorize chromophores as
