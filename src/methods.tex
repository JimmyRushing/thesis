...
Using the canonical ensemble (NVT) for example, holding the number of
particles, the volume, and the temperature constant allows for the exploration of the potential energy surface
