...
A free charges movement through a morphology can be modeled as a series of charge transfer reactions, or
`hops' between relatively weakly interacting chromophores in the system. 
Marcus's nonadiabatic electron transfer theory allows us to model each individual hop between chromophores as two
