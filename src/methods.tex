...
For OPV's, it would be undesirable for a chomophore to relax to its ground
state and release a photon. That is, it is preferred that our molecules bear that photo-electric
...
With that said, a chromophore is defined as a region over which the
LUMO of an excited electron is fully delocalized, and is, therefore a carrier
of a free charge. 
