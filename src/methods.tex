...
The software chosen to implement the MINDO/3 method is
...
pySCF allowed for the entire QQC code to be implememted in five lines of code. Are natively maintaned package
MorphCT, discussed in
...
energetics in isolation.  . However, the P3HT morphologies discussed in the evaluation section of the results
consist of 1000 oligomers of 15 repeating molecular units. 


. Furthermore, variations in TI do not effect mobility calcs
that much (one of evans papers said this).   Jones2017 showed that with this you can connect MD
