...
\hline % inserts single horizontal line
    foyer & python package for applying atom-typing rules  \cite{Klein2018a}\\ % inserting body of the table
freud & python package for analyzing particle simulations  \cite{Ramasubramani2020}\\ %
...
voronoi analysis.
After chopping up the morphology into chromophores ...
...
as a discrete event that occurs at a rate.

Taking \autoref{marcus} to be and
