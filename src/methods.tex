...
Predicting morphology and charge transport properties in \glsxtrshort{opv}s is accomplished through the combination 
...
It is clear from this image that the choice of $d_{cut}$ is could drastically effect the
neighbor list.  
...
can make in silico screening of \glsxtrshort{opv} materials realistically attainable by any aspiring researcher.
...
\texttt{HOOMD-Blue} for performing MD simulations of self-assembly in \glsxtrshort{opv}s.  \texttt{Planckton}
