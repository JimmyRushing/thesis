...
With the conductivity of a material given by 
\begin{align}
    \label{conductivity}
    \sigma = n \cdot e \cdot \mu,
\end{align}
where $n$ is the number of charge carriers, $e$ is the charge of an electron and $\mu$ is empirically
defined as drift velocity, $v$, over the electric field, $E$ as follows:
\begin{align}
    \label{m}
    \mu = \frac{v}{E}
\end{align}

With that, our KMC model most closely represents a measure of conductivity for very small $n$ and negligible
$E$

Zero-field mobility is a measure of conductivity without the presence
of an electric field. This model most closely matches time-of-flight
expirements carried out on very thin films under low charge density conditions. 
