...
systems. The MD simulation used in this work begins by packing a specified number of molecules into a
simulation box. It proceeds iteratively allowing small random motions and solving Newtons laws of motion
based on predefined interatomic interaction potentials. Using the canonical ensemble (NVT),
