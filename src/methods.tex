...
x is a random number between 0 and 1. This rationally reshuffles the queue of events and indroduces signifcant stochasticism. The waittime then looks as follows:
