...
%\includegraphics[width=25cm]{figures/crystalline_voronoi.png}
 ...
 % \includegraphics[width=\linewidth]{figures/crystalline_voronoi_smaller.png}
  \caption{A 2D Voronoi diagram that was drawn from the xy components of a crystalline \glsxtrshort{p3ht} morphology. Dots
...
\autoref{dcutresults}, we test the sensitiviy of our results to the value of dcut for the crystalline \glsxtrshort{p3ht}
...
the queue. For example, a charge carrier that hopped a million times, and had
...
shortened by 5 orders, ${\sim}500$ shortened by 4 orders of magnitude, and so
on.
...
From the rationally shuffled queue, the shortest wait time is chosen and the charge is moved to
...
average over the chosen number of individual hopping simulations. 
...
goes to infinity can be estimated as a linear fit between the \glsxtrshort{msd} of charge carriers at the specified lifetimes.
