...
With this one electron charge transfer reaction, the driving force for 
the reaction, $\Delta E_{ij}$, is the difference between the energy that it currently posseses 
...
\begin{align}
    ...
    \label{gibbs}
\end{align}
$T_{ij}$, the electronic orbital overlap between chromophores, can be obtained using 
the dimer splitting methed [REFS]. This method comares 
$\Delta E_{ij}$ to the energy the electron occupying the frontier molecular orbitals of a dimer consisting if
