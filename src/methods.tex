...
justified but drastic simplifications are necessary. Compution of the eigenvalues of the HOMO and HOMO-1
...
integral. It is this appoximation that allows an estimationg of the transfer integral from the calculation of
...
approximation, which further neglects the site energy integral, therby assuming all chromophores have the same
