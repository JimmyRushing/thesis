...
A particular 
choice of method comes down to how well we can organize a workflow and integrate the QCC portion of the
...
thousands of individual kMC implementations to arrive at a charge mobility prediction. 
...
The software we have chosen to perform our QCC is
...
\texttt{pySCF} allowed for the entire QCC code to be implememted in five lines of code. These lines of code in 
