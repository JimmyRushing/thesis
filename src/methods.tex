...
%\includegraphics[width=25cm]{figures/crystalline_voronoi.png}
  \includegraphics[width=\linewidth, height=\textheight,keepaspectratio]{figures/crystalline_voronoi.png} 
...
center than any other chromopore center. We use voronoi because BLAH.
