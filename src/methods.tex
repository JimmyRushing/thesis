...
individual chromophores. Each chemistry requires its own justification for which segments in the morphology
should be considered to harbor a fully delocalized charge. Researchers found that, despite experimental
results suggesting that delocalizaion occurs along roughly 7 monomers in P3HT, treating every monomer as a
chromophore gave accurate results. With ITIC, the frontier molecular orbitals, that is, the HOMO
...
backbone and the whole molecule and compare carrier mobility. 
 ...
 At this stage of the workflow, consideration needs to be
given to where a charge may delocalize within. \label{marcus}
