...
the geometric center of the chromphore.

As a demonstration, we describe and visualize the voronoi analysis of the xy components of the these
coordinates for the crystalline P3HT system described in \autoref{md}. 

This 2D analogue works the same way but it is more easily visualized.
of voronoi analysis of an MD simulation data, we visualize a 2D voronoi analysis
of the 
...
and its geometrically closest neighbor across the line. 

MorphCT incorperates a module from the Freud

Voronoi analysis is performed on the morphology prior to the to find

to do the dimer calculation described above requires the use of an effecient algorithim for neighbor finding.
