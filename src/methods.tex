...
\autoref{dcutresults}, we test the sensitivity of our results to the value of dcut for the crystalline \glsxtrshort{p3ht}
...
The slope of the \glsxtrshort{msd} (diffusion coefficient), $D$, as time
goes to infinity can be estimated as a linear fit between the \glsxtrshort{msd} at the specified lifetimes.
...
\texttt{Planckton} and \texttt{MorphCT}, for 

We manage the development of the \texttt{Planckton} and \texttt{MorphCT} software packages using public repositories hosted at github.com\cite{cmelab} for the execution of these methods.
