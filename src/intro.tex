...
\ej{Grammar nitpick, two "theys" in this sentence referring to differen things and ``soon to follow'' underspecified.} are soon to folow \cite{Chen2020}. 

Exciting 

\ej{Not urgent, but subjective adjectives like ``exciting'' can usually be replaced with a factual description or an explanation of who is actually excited by the facts to make it clearer and correcter.} research is being done to provide stretchability, self-healing, and biodegradability for 
