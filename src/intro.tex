...
constitute the experince of an end user. Also maintained on github is a sister package called Planckton-Flow
which allowed me to take a conainter of planckton off the shelf and run MD simulation of benchmark OPV
molecules on a high performance computing cluster without having to build the software stack. The  
