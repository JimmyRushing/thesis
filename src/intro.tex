...
\glsxtrshort{osc} devices exhibit improvements in
flexibility, processability, and cost of manufacturing.
They are also used in more revolutionary electronic designs.
For example, researchers have exploited the relatively narrow window
of${\sim}300nm$ to make windows that act as OSCs. 
...
OSC's are approaching 20\% efficiency \cite{Liu2020b}.
