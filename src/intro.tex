...
\ej{This paragraph needs a big fix. }
...
invention of the \glsxtrshort{bhj}.
...
As described in \ref{bhj}, a \glsxtrshort{bhj} active layer harvests photons through the following 
...
in \autoref{results}, drastically increases charge mobility. This trend is borne out in through our
...
workflow on three benchmark MD simulated morphologies of \glsxtrshort{p3ht}. 
