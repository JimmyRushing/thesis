...
through pure domains of donor or acceptor material. These materials can be deposited as a solution or printed
on a surface. How these materials will self-assemble in the environment in which they are deposited determines
the morphology. We seek to use MD simulations to simulate the self-assembly of these materials. Successfully
doing so could inform the ideal conditions for optimizing the morphology.
