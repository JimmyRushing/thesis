...
constitute the experience of an end user. Using Planckton-flow (also maintained on github), a sister package
of Planckton we take a container of planckton off the shelf and run MD simulation of benchmark OPV
...
informs the direction with which we seek to take MorphCT. 
