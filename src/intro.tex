...
TVs and cellphones displays. They enable cutting edge
...
In this thesis, we focus on \gls{opv} materials. \glsxtrshort{opv}s are a subclass of organic semiconductors that are used in the active layer of \gls{osc} devices.  
...
organic materials. Namely, that absorption spectrum
...
its ground state, it is critical that absorption take place as near as possible to the donor/acceptor
interface. 
