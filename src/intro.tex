...
Cutting edge foldable \glsxtrshort{oled} screens are commercially available, and a rollable tv was debuted in 2019
\cite{Chen2020}. 
...
photon of commenserate energy is incedent on the molecule. \glsxtrshort{opv} materials are instead distinguished by
...
invention of the \glsxtrshort{bhj}. The coloumbic attraction, $V$, between the an excited
...
\end{subfigure}
    \caption[short]{(A) \glsxtrshort{p3ht} oligomer composed of 15 identical monomers imbued in blue.
