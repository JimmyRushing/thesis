...
work, and often utilize proprietary software. The software used in this work is maintained in public and in the
case of MorphCT, which is undergoing active develpment for the express purposes of this thesis, workflows are
