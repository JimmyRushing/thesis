...
light in the green region which can damage DNA. 
...
for brevitys sake. It is taken to be defined as a molecular segment over which the wave function of an
electron (hole) is thought to be fully delocolized in a pure accpetor (donor) domain. 
