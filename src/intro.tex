...
The proximate \ej{proximate? not sure that's true if the immediate work we do is not using novel ways to engineer these things for OPVS. It's *A* motivation but not the leading one?}
motivation for this research is the wide range of novels ways that these materials can be
