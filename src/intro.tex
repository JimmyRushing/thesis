...
In this thesis, we explore the TRUEness of the pipeline from the start to finish. What I found was the largest
cognitive load was in the quantum theory underlying the algorithm at the molecular level and the cognitive
load of learning the MorphCT API. It means we need jupyter notebooks to sell this stuff to first time buyers.
