...
exciton diffusion, charge transfer, and free charge diffusion \cite{Fusella2019}. When a photon is incedent on
...
the end groups of the ITIC molecule. They found, using DFT, that this substitution could lower the exciton
...
that unfolded over the course of three decades. The modularity of the FREA design lends itself to the
kind of computational experimentation explored below. We contend that if not as a substitute for wetlab
experiments, as a suplimentary tool.  
