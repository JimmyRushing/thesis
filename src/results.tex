...
organic analague of p-type inorganic semiconductors and donors the analogue of the n-type. 
As is well visualized by \cite{Han2019}, the LUMO of ITIC delocalizes along the backbone of the molecule, with
neglidgible electron density in the side chains. This makes the the backbone of this kind of small molecule
material the obvious choice. In more polymeric materials like P3HT, the hopping model has recieved further
...
monitonically scale with the calculated mobilioty in this algorith.
