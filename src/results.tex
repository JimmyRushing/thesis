...
temperature, 15 \glsxtrshort{kmc} simulations from 100K to 800k were run on the benchmark P3HT crystalline morphology. It
...
An unanticipated result is that increasing the temperature of the \glsxtrshort{kmc}
