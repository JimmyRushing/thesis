...
Introduced in \autoref{kmcanaylsis}, the `carrier lifetimes' chosen for a given
...
It is advised that a preanalysis to determine where a given morphology's \glsxtrshort{msd} will converge be performed so as to never simulate past that point. 
