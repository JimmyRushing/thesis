...
calculating the HOMO(or LUMO) of the dimer formed by the two chromophpres. To evaluate pySCF's suitability for
these tasks we perform two experiments: (1) Comparing frontier molecular energies given by pySCF to those
given by more rigerous DFT and (2) Comparing pySCF's dimer calculations to a study that used ORCA.  
