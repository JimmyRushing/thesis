...
The $T_{ij}$ resulting from these $5680$ orientations are shown in \autoref{TIplots}(b). 
...
\end{subfigure}
    \caption{The orientations in figure (a) display the oreintation with the hightest $T_{ij}$ on the left and
    the lowest on the right. Individual dots in figure (b) correspond to $5680$ 
