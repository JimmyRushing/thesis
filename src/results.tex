...
molecule morphology of ITIC was equillibrated over 10e-7 step  MD simulation at room temperature. From the results of the MD
...
been used to affect elsewhere[REFS]. With this atomistic morphology, to carry a hopping model necesitates
delineating segments within the morphology upon which charges can delocalize along the within a the HOMO(or in
the case of LUMO for the acceptor). It should be said that acceptor in this context doesn't refer to
