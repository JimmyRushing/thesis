...
with the y-axis running through the sulfur atom as shown in \autoref{TIplots}(a). 
A second thoiphene was instatiated and displaced from the origin for each member of the cartesian product of
the sets of following sets of moves: 12 even steps along the x-axes from $0-5 \AA$, 12 evenly spaced rotations
ej{this feels like over describing I think I can draw a picture?} 

. This process carried out
for every member of the cartesian product of the 
A second thiophene was instantiated 
and allowed a combination of moves wherein it was translated
in the positive z and x direction by up to 5 angstroms 
and rotated up to 180 degrees about its y-axis or z-axis. Oreintations resulting in atoms that were less
