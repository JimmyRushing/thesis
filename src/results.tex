...
\ej{this paragraph was moved from the msd section to here so it need to be
adjusted}
...
squared displacement averaged over 1000 holes at $10^{-9}s$ and again $10^{-10}s$ the slope of the \glsxtrshort{msd} can be reproduced with 1000's less individual holes having to be simulated. The results in the accuracy
section above were acquired with these 2 chosen lifetimes.
...
\texttt{pySCF} is speedy enough such that introducing dcut adds more ambiguity
...
orders of magnitude beyond that at $10^{-8}s$.
