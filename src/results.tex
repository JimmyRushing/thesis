...
The fused thiohpenes represent a generic FREA core, wherein the the charge transfer between chromophores
will take place. 

The HOMO-LUMO gap which approximates the energy required to bump the electron
up an energy level and is therefore a measure of how the cost of electron transfer. 
...
were intialized and saved to a GSD file. The frontier
molecular orbitals are quantified with pySCF as outlined in \autoref{qccmethods}.
