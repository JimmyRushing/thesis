...
where realistic distances between thiophene rings in lamaeler \glsxtrshort{p3ht} crystals 
...
molecule morphology of \glsxtrshort{itic} was equilibrated over a $10^{7}$ step MD simulation at room temperature. 
