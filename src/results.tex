...
With a pySCF integrated into MorphCT for reasons oultined in \autoref{morphct},
we validate our charge mobility prediction against an exhisting work. 
The MD data \cite{P3HTData} was provided by researchers for validation and research purposes \cite{Miller2018}.

The data is provided is the final frame of coarse-grained MD simulations
...
at which indiviual grains can form within the morphology. The oreintation and boundaries of these grains effect
