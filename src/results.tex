...
experiments meant to evaluate \texttt{pySCF}'s suitabilitity for performing these duties:
...
If, in the future, more computationally expensive methods are incorperated into the \glsxtrshort{qcc} step, or chromophores in other
...
\end{subfigure}
    \caption{Figure (A) shows how KMC simulated mobility values scale with the perscribed
