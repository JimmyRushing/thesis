...
benchmark P3HT morphology, and holding all other parameters constant and doing sweeps of these 
values individually provides context for how treat these parameters in future investigations. 
