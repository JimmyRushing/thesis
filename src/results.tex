...
\subsection{Quantum Calculation Validation}
...
\subsection{Charge Transport Validation}
\label{mobility}
\begin{table}[ht]
...
this work has provided benchmark morphologies and the associated mobilites for validation purposes. 

\ej{THE PART IN QUOTE BLOCK WAS RIPPED FROM METHOD SO IT ISNT STRUCTURED}
""""""""""""""""""""""""""""""""""""""""""
...
\hline\hline %inserts double horizontal lines
dcut $\AA$ & 4 & 6 & 8 & 10 & 12 & 14 & 16 \\ [0.5ex] % inserts table
%heading
\hline  % inserts single horizontal line
