...
product of these sets define a space of $20736$ oreintations for second thiophene. 
...
unphysical. The resulting $5680$ atomic arrangements were saved to a GSD and the $T_{ij}$s quantified with MorphCT. 
