...
to the chromophore object. It is defaulted to $~300meV$ as for all chromophore
objects.
...
This is as easy as retrieving the pickled crystalline system, looping through the chromophores, setting the
