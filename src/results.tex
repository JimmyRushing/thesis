...
Comprable mobilities of $(1.019 \pm .001)\cdot 10^{-3}$ or the backbone chromophores and 
$(1.285 \pm .001)\cdot 10^{-3}$ [rerunning this because it got over written] for the whole molecule. 
